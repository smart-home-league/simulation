"""
U14 example controller: uses distance sensors (primary) and bumpers (fallback),
ground color sensor, receiver, LEDs, wheel encoders.
Copy to controllers/robot/robot.py and set world subleague to U14.
...
robot = RobotU14(team_name="U14 Example")
robot.led_on = True
...
def floor_ahead_dusty() -> bool:
    r, g, b = robot.color_sensor
    return (r + g + b) / 3 < FLOOR_DUSTY_THRESHOLD
